...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                ...
                .AddGoogle(options =>
                {
                    options.ClientId = "1039613541997-tchiq10o7g62vopg2c55us3h6918m9ht.apps.googleusercontent.com";
                    options.ClientSecret = "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";
                })
                .AddCookie(options =>{});
#endregion
...
app.MapGet("/", (HttpContext context) =>
{
    ...
    {
        return $"Hello {context.User.Identity.Name}, you're authenticated!";
    }
    return "Hello, please log in!";
});

app.MapGet("/login", () => Results.Redirect("/signin-google"));
