...
namespace VehicleServiceAPI.Services
{
    public class BookingService : IBookingService
    {
        ...
        /// <summary>
        /// Update the service details of a booking.
        /// </summary>
        public async Task<BookingDTO> UpdateServiceDetailsAsync(int UserId, BookingServiceDetailsDTO request)
        {
            ...
            {
                throw new InvalidOperationException("You do not have permission to update this booking.");
            }
            booking.ServiceDetails = request.ServiceDetails;
            var updatedBooking = await _bookingRepository.UpdateAsync(booking);
            return await MapBookingToDto(updatedBooking);
        }
